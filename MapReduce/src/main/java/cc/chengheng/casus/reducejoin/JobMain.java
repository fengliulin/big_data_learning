...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        // 1、创建一个job任务对象
        Job job = Job.getInstance(getConf(), "reduce_join");
...
//      TextInputFormat.addInputPath(job, new Path("hdfs://192.168.1.100:8020/wordcount"));
        TextInputFormat.addInputPath(job, new Path("file:///Users/fengliulin/Documents/join_input"));
...
//        Path path = new Path("hdfs://192.168.1.100:8020/wordcount_out");
        Path path = new Path("file:///Users/fengliulin/Documents/join_out");
        TextOutputFormat.setOutputPath(job, path);

        // 判断目录是否存在，存在就删除
        FileSystem fileSystem = FileSystem.get(new URI("file:///Users/fengliulin/Documents/join_out"), new Configuration());
