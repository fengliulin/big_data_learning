...
//        Path path = new Path("hdfs://192.168.1.100:8020/wordcount_out");
        Path path = new Path("file:///Users/fengliulin/Documents/combiner_input");
        TextOutputFormat.setOutputPath(job, path);

        // 判断目录是否存在，存在就删除
        FileSystem fileSystem = FileSystem.get(new URI("file:///Users/fengliulin/Documents/combiner_input"), new Configuration());
